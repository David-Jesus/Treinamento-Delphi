...
type
  ...
  private
    ...
    procedure OnAntesConfirmar(var prData: String);
        ...
        try
          ...
          if (CompareStr(FTeste, edLogin.Text) = 0) then
             begin
               ...
               try
                 wFrEnviaEmail := TfrEnvioEmail.Create(nil);
...
procedure TForm1.OnAntesConfirmar(var prData: String);
  begin
    ...
    FHTTP.SetaRequestHeader('Referer', 'http://www.sc.inf.br/intranet/logado.php');
    FHTTP.SetaRequestHeader('Accept-Language', 'pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7');

    prData := 'restauranteId=1&obs='
  end;
