...
begin
  ...
  wMaior      := 0;
  Writeln('|-------------------------------------------------------------------------------------|');
  Writeln('|Sistema Para calcular a média, mostrar o maior e menor número de 5 valores informados|');
